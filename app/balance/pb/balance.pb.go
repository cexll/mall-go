...
type GetBalanceResponse struct {
	...
	Freeze    float32 `protobuf:"fixed32,5,opt,name=freeze,proto3" json:"freeze,omitempty"`
}
...
func (x *GetBalanceResponse) GetAvailable() float32 {
	if x != nil {
		return x.Available
	}
	return 0
...
func (x *GetBalanceResponse) GetFreeze() float32 {
	if x != nil {
		return x.Freeze
	}
	return 0
...
func (x *SubBalanceRequest) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
func (x *ReduceBalanceRequest) GetAmount() float32 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_balance_proto_rawDesc = []byte{
	...
	0x6c, 0x61, 0x62, 0x6c, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x66, 0x72, 0x65, 0x65, 0x7a, 0x65, 0x18,
	0x05, 0x20, 0x01, 0x28, 0x02, 0x52, 0x06, 0x66, 0x72, 0x65, 0x65, 0x7a, 0x65, 0x22, 0x4f, 0x0a,
	...
	0x28, 0x02, 0x52, 0x06, 0x61, 0x6d, 0x6f, 0x75, 0x6e, 0x74, 0x12, 0x12, 0x0a, 0x04, 0x64, 0x65,
